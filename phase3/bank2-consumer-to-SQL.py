...
with db_engine.connect() as connect:
    ...
    connect.execute(f'CREATE TABLE IF NOT EXISTS bank2_transactions'
    ...
    def handleMessages(self):
        for message in self.consumer:
            ...
            with engine.connect() as connection:
                connection.execute('insert into bank2_transactions ({0}, {1}, {2}, {3}, {4})'.format(message['custid'], message['bankid'],  message['type'], message['date'], message['amt']))
